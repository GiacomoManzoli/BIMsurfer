...
console.log("Loading BIMSURFER.ClickSelect custom");
...
BIMSURFER.Control.ClickSelect = BIMSURFER.Class(BIMSURFER.Control, {
    ...
    initEvents: function() {
        if (this.active) {
            ...
            this.SYSTEM.evenster("mouseUp", this.mouseUp, this);
        }
        return this;
    },
    ...
    mouseUp: function(e) {
        if (
            (e.offsetX > this.downX ? e.offsetX - this.downX < 5 : this.downX - e.offsetX < 5) &&
